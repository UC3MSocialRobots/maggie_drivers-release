Name:           ros-hydro-maggie-ir-drivers
Version:        0.0.4
Release:        0%{?dist}
Summary:        ROS maggie_ir_drivers package

Group:          Development/Libraries
License:        LEUC3M v1.0
URL:            http://wiki.ros.org/maggie_ir_drivers
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-hydro-ir-trans-drivers
Requires:       ros-hydro-roscpp
BuildRequires:  gmock-devel
BuildRequires:  gtest-devel
BuildRequires:  ros-hydro-catkin
BuildRequires:  ros-hydro-ir-trans-drivers
